...
var (
	...
	webhookHeaderKey     = flag.String("webhook-header-key", "null", "the HTTP header key to use to send the webhook (GET method only)")
	webhookHeaderValue     = flag.String("webhook-header-value", "null", "the HTTP header value to use to send the webhook (GET method only)")
